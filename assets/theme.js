...
var selectors$15 = {
  ...
  slidePreviousButton: '.slider-nav__previous',
  slideNextButton: '.slider-nav__next',
...
var revealSlider = {
  ...
  disableButton: function(buttonClicked) {
    const button = buttonClicked === 'nextslide' ? selectors$15.slideNextButton : selectors$15.slidePreviousButton
    $(button).prop('disabled',true);
    setTimeout(function(){
      // enable click after .25 second
...
sections.register('header-section', {
  ...
  _toggleHeaderPosition: function() {
    ...
    if (scrollTop <= 0) {
      ...
      // this makes it appear on scroll up
      requestAnimationFrame(this._promiseHeaderSlideIn.bind(this));
      clearTimeout(timer);
      const _this = this;
      timer = setTimeout(function () {
          if (_this.scrollTop === 0 || $('body').hasClass('navigation-open')) return;
          requestAnimationFrame(_this._promiseHeaderSlideOut.bind(_this));
      }, 3000);
      ...
      clearTimeout(timer);
      // this makes it disappear on scroll down
